...
import {IconCalcSwp, ValueDisplaySwp, TitleCalc2, FinalButton1} from './../styles/SwpStyles.jsx';
    ...
    return (
        <CalculatorWrapper>
            <CalculatorWrapperInner>
                <IconCalcSwp>
                    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
                        <title>wallet_3_line</title>
                        <g id="wallet_3_line" fill='none'>
                            <path d='M24 0v24H0V0zM12.593 23.258l-.011.002-.071.035-.02.004-.014-.004-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113-.013.002-.185.093-.01.01-.003.011.018.43.005.012.008.007.201.093c.012.004.023 0 .029-.008l.004-.014-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014-.034.614c0 .012.007.02.017.024l.015-.002.201-.093.01-.008.004-.011.017-.43-.003-.012-.01-.01z'/>
                            <path fill='#FFFFFFFF' d='M16 4a1 1 0 0 1 .117 1.993L16 6H5.5a.5.5 0 0 0-.09.992L5.5 7H19a2 2 0 0 1 1.995 1.85L21 9v9a2 2 0 0 1-1.85 1.995L19 20H5a2 2 0 0 1-1.995-1.85L3 18V6.5a2.5 2.5 0 0 1 2.336-2.495L5.5 4zM5 8.95V18h14V9H5.5c-.114 0-.227-.008-.337-.022zM15.5 12a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3'/>
                        </g>
                    </svg>
                </IconCalcSwp>
                <TitleText>
                    <TitleCalc2>SWP Calculator</TitleCalc2>
                    <TitleCalc>Calculate Systematic Withdrawal Plan returns</TitleCalc>
                </TitleText>
            </CalculatorWrapperInner>
            <InputGroup>
                <HeaderRow>
                    <Label>
                        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>currency_dollar_2_line</title><g id="currency_dollar_2_line" fill='none'><path d='M0 0h24v24H0z'/><path fill='#007AFFFF' d='M13 4a1 1 0 1 0-2 0v1H9.5a4 4 0 1 0 0 8h5a2 2 0 1 1 0 4H7a1 1 0 1 0 0 2h4v1a1 1 0 1 0 2 0v-1h1.5a4 4 0 0 0 0-8h-5a2 2 0 1 1 0-4H17a1 1 0 1 0 0-2h-4z'/></g></svg>
                        Initial Investment
                    </Label>
            ...
            <InputGroup>
                <HeaderRow>
                    <Label>
                        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>wallet_3_line</title><g id="wallet_3_line" fill='none'><path d='M24 0v24H0V0zM12.593 23.258l-.011.002-.071.035-.02.004-.014-.004-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113-.013.002-.185.093-.01.01-.003.011.018.43.005.012.008.007.201.093c.012.004.023 0 .029-.008l.004-.014-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014-.034.614c0 .012.007.02.017.024l.015-.002.201-.093.01-.008.004-.011.017-.43-.003-.012-.01-.01z'/><path fill='#007AFFFF' d='M16 4a1 1 0 0 1 .117 1.993L16 6H5.5a.5.5 0 0 0-.09.992L5.5 7H19a2 2 0 0 1 1.995 1.85L21 9v9a2 2 0 0 1-1.85 1.995L19 20H5a2 2 0 0 1-1.995-1.85L3 18V6.5a2.5 2.5 0 0 1 2.336-2.495L5.5 4zM5 8.95V18h14V9H5.5c-.114 0-.227-.008-.337-.022zM15.5 12a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3'/></g></svg>
                        Monthly Withdrawal
                    </Label>
            ...
            <FinalButton1>Calculate Withdrawals</FinalButton1>
