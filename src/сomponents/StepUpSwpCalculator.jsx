...
import {IconCalcSwp, ValueDisplaySwp, TitleCalc3, FinalButton} from './../styles/StepUpSwp.jsx';

const StepUpSwpCalculator = () => {
    const [investment, setInvestment] = useState(500);
    const [withdrawal, setWithdrawal] = useState(100);
    ...
    const handleChange = (event) => {
        ...
        setWithdrawal(Number(newWithdrawal));
    }

    const handleChangeAnnual = (event) => {
        const newAnnual = event.target.value;
        setAnnual(Number(newAnnual));
    }
    ...
    return (
        <CalculatorWrapper>
            <CalculatorWrapperInner>
                <IconCalcSwp>
                    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
                        ...
                        <g id="arrow_down_circle_line" fill='none' fill-rule='nonzero'>
                ...
                <TitleText>
                    <TitleCalc3>Step Up SWP Calculator</TitleCalc3>
                    <TitleCalc>Calculate SWP with annual withdrawal increment</TitleCalc>
                </TitleText>
            </CalculatorWrapperInner>
            <InputGroup>
                <HeaderRow>
                    <Label>
                        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>currency_dollar_2_line</title><g id="currency_dollar_2_line" fill='none'><path d='M0 0h24v24H0z'/><path fill='#F54A00FF' d='M13 4a1 1 0 1 0-2 0v1H9.5a4 4 0 1 0 0 8h5a2 2 0 1 1 0 4H7a1 1 0 1 0 0 2h4v1a1 1 0 1 0 2 0v-1h1.5a4 4 0 0 0 0-8h-5a2 2 0 1 1 0-4H17a1 1 0 1 0 0-2h-4z'/></g></svg>
                        Initial Investment
                    </Label>
            ...
            <InputGroup>
                <HeaderRow>
                    <Label>
                        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>arrow_down_circle_line</title><g id="arrow_down_circle_line" fill='none' fill-rule='nonzero'><path d='M24 0v24H0V0h24ZM12.594 23.258l-.012.002-.071.035-.02.004-.014-.004-.071-.036c-.01-.003-.019 0-.024.006l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427c-.002-.01-.009-.017-.016-.018Zm.264-.113-.014.002-.184.093-.01.01-.003.011.018.43.005.012.008.008.201.092c.012.004.023 0 .029-.008l.004-.014-.034-.614c-.003-.012-.01-.02-.02-.022Zm-.715.002a.023.023 0 0 0-.027.006l-.006.014-.034.614c0 .012.007.02.017.024l.015-.002.201-.093.01-.008.003-.011.018-.43-.003-.012-.01-.01-.184-.092Z'/><path fill='#F54A00FF' d='M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm0 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm0 2.757a1 1 0 0 1 .993.884l.007.116v6.076l1.828-1.828a1 1 0 0 1 1.498 1.32l-.084.094-3.535 3.535a1 1 0 0 1-1.32.083l-.094-.083-3.536-3.535a1 1 0 0 1 1.32-1.498l.094.084 1.83 1.828V7.757a1 1 0 0 1 1-1Z'/></g></svg>
                        Initial Monthly Withdrawal
                    </Label>
                    <ValueDisplaySwp>${withdrawal.toLocaleString()}</ValueDisplaySwp>
                </HeaderRow>
                <StyledRangeInput type="range" min="100" max="10000" step="100" value={withdrawal} onChange={handleChange}/>
            </InputGroup>

            <InputGroup>
                <HeaderRow>
                    <Label>
                        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>trending_down_line</title><g id="trending_down_line" fill='none' fill-rule='nonzero'><path d='M24 0v24H0V0h24ZM12.594 23.258l-.012.002-.071.035-.02.004-.014-.004-.071-.036c-.01-.003-.019 0-.024.006l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427c-.002-.01-.009-.017-.016-.018Zm.264-.113-.014.002-.184.093-.01.01-.003.011.018.43.005.012.008.008.201.092c.012.004.023 0 .029-.008l.004-.014-.034-.614c-.003-.012-.01-.02-.02-.022Zm-.715.002a.023.023 0 0 0-.027.006l-.006.014-.034.614c0 .012.007.02.017.024l.015-.002.201-.093.01-.008.003-.011.018-.43-.003-.012-.01-.01-.184-.092Z'/><path fill='#F54A00FF' d='M18.586 16H17a1 1 0 1 0 0 2h4a1 1 0 0 0 1-1v-4a1 1 0 1 0-2 0v1.586l-5.293-5.293a1 1 0 0 0-1.414 0L9.5 13.086 3.707 7.293a1 1 0 0 0-1.414 1.414l6.5 6.5a1 1 0 0 0 1.414 0L14 11.414 18.586 16Z'/></g></svg>
                        Annual Step-Up
                    </Label>
                    <ValueDisplaySwp>{annual.toLocaleString()} %</ValueDisplaySwp>
                </HeaderRow>
                <StyledRangeInput type="range" min="0" max="20" step="0.5" value={annual} onChange={handleChangeAnnual}/>
            </InputGroup>

            <InputGroup>
                <HeaderRow>
                    <Label>
                        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>percentage_line</title><title>percentage_line</title><g id="percentage_line" fill='none' fill-rule='nonzero'><path d='M24 0v24H0V0zM12.594 23.258l-.012.002-.071.035-.02.004-.014-.004-.071-.036q-.016-.004-.024.006l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427q-.004-.016-.016-.018m.264-.113-.014.002-.184.093-.01.01-.003.011.018.43.005.012.008.008.201.092q.019.005.029-.008l.004-.014-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014-.034.614q.001.018.017.024l.015-.002.201-.093.01-.008.003-.011.018-.43-.003-.012-.01-.01z'/><path fill='#F54A00FF' d='M18.293 4.293a1 1 0 1 1 1.414 1.414l-14 14a1 1 0 1 1-1.414-1.414zM18 17a1 1 0 1 0-2 0 1 1 0 0 0 2 0M8 7a1 1 0 1 0-2 0 1 1 0 0 0 2 0m12 10a3 3 0 1 1-6 0 3 3 0 0 1 6 0M10 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0'/></g></svg>
                        Expected Return (% p.a.)
                    </Label>
            ...
            <FinalButton>Calculate Withdrawals</FinalButton>

        </CalculatorWrapper>
    );
};

export default StepUpSwpCalculator;